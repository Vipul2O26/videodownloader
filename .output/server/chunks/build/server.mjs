import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, hasInjectionContext, inject, computed, unref, getCurrentInstance, defineAsyncComponent, createElementBlock, provide, cloneVNode, useSSRContext, createApp, onServerPrefetch, useModel, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, ref, watch, resolveDynamicComponent, useSlots, isRef, onErrorCaptured, shallowReactive, reactive, effectScope, toValue, getCurrentScope, toRef, nextTick, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, n as parseQuery, o as hasProtocol, q as joinURL, t as parseURL, f as encodePath, w as decodePath, x as isScriptProtocol, y as withQuery, z as getContext, A as withTrailingSlash, B as withoutTrailingSlash, C as sanitizeStatusCode, $ as $fetch$1, D as baseURL, E as defuFn, F as klona, G as defu, H as createHooks, c as createError$1, I as isEqual, J as isEqual$1, K as stringifyParsedURL, L as stringifyQuery } from '../nitro/nitro.mjs';
...
import { useVModel, reactiveOmit, reactivePick, useDebounceFn } from '@vueuse/core';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-iBCKxnii.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D1mMctay.mjs'));
...
export { __nuxt_component_0 as _, entry_default as default, useHead as u };

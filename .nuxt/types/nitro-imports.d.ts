declare global {
  const BackgroundQueue: typeof import('../../server/utils/queue').BackgroundQueue
  const H3Error: typeof import('../../node_modules/h3').H3Error
  const H3Event: typeof import('../../node_modules/h3').H3Event
  const TEMP_DIRECTORY: typeof import('../../server/utils/storage').TEMP_DIRECTORY
  ...
  const analyze_media: typeof import('../../server/utils/media').analyze_media
  ...
  const assertSizeLimit: typeof import('../../server/utils/security').assertSizeLimit
  const cachedEventHandler: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  const callNodeListener: typeof import('../../node_modules/h3').callNodeListener
  const cleanupTemporaryFiles: typeof import('../../server/utils/storage').cleanupTemporaryFiles
  ...
  const direct_media_download: typeof import('../../server/utils/media').direct_media_download
  const download_authorized_media: typeof import('../../server/utils/media').download_authorized_media
  const dynamicEventHandler: typeof import('../../node_modules/h3').dynamicEventHandler
  const enforceRateLimit: typeof import('../../server/utils/security').enforceRateLimit
  const ensureTemporaryDirectory: typeof import('../../server/utils/storage').ensureTemporaryDirectory
  const eventHandler: typeof import('../../node_modules/h3').eventHandler
  const fetchWithEvent: typeof import('../../node_modules/h3').fetchWithEvent
  const formatBytes: typeof import('../../server/utils/security').formatBytes
  ...
  const getHostname: typeof import('../../server/utils/security').getHostname
  ...
  const get_media_info: typeof import('../../server/utils/media').get_media_info
  ...
  const mediaQueue: typeof import('../../server/utils/queue').mediaQueue
  ...
  const safeFetch: typeof import('../../server/utils/security').safeFetch
  ...
  const validateUrl: typeof import('../../server/utils/security').validateUrl
  const withTimeout: typeof import('../../server/utils/security').withTimeout
  const writeEarlyHints: typeof import('../../node_modules/h3').writeEarlyHints
  const writeTemporaryFile: typeof import('../../server/utils/storage').writeTemporaryFile
}
// for type re-export
declare global {
  // @ts-ignore
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/workspaces/videodownloader/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/workspaces/videodownloader/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { analyze_media, get_media_info, download_authorized_media, direct_media_download } from '/workspaces/videodownloader/server/utils/media';
export { BackgroundQueue, mediaQueue } from '/workspaces/videodownloader/server/utils/queue';
export { getHostname, validateUrl, assertSizeLimit, formatBytes, withTimeout, enforceRateLimit, safeFetch } from '/workspaces/videodownloader/server/utils/security';
export { TEMP_DIRECTORY, ensureTemporaryDirectory, writeTemporaryFile, cleanupTemporaryFiles } from '/workspaces/videodownloader/server/utils/storage';